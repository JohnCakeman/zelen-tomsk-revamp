        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative fade-in [animation-delay:0.5s]">
            <div className="rounded-2xl overflow-hidden bg-white p-4 shadow-lg rotate-3 transform hover-scale">
              <img 
                src="https://images.unsplash.com/photo-1579113800032-c38bd7635818?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" 
            ...
            <div className="absolute -bottom-10 -left-10 bg-white p-4 rounded-xl shadow-lg -rotate-6 hidden md:block hover-scale z-10">
              <img 
                src="https://images.unsplash.com/photo-1622623384207-6f912404de5a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80" 
